...
const itinerariesActions = {
    getItineraries: () => {
        return async (dispatch, getState) => {
            const res = await axios.get('https://my-tinerary-fenoglio-backend.herokuapp.com/api/itineraries')
    ...
    getOneItinerary: (id) => {
        return async (dispatch, getState) => {
            const res = await axios.get(`https://my-tinerary-fenoglio-backend.herokuapp.com/api/itineraries/${id}`)
    ...
    findItinerariesFromCity: (id) => {
        return async (dispatch, getState) => {
            const res = await axios.get(`https://my-tinerary-fenoglio-backend.herokuapp.com/api/itinerariesbycities/${id}`)
            // console.log(res)
    ...
    likeDislike: (itineraryId) => {
        ...
        return async () => {
            try {
                ...
                let response = await axios.put(`https://my-tinerary-fenoglio-backend.herokuapp.com/api/like/${itineraryId}`, {},
                {headers: {
